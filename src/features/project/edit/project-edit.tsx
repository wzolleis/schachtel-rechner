...
import {NoProjectFoundError} from "@/features/project/errors/no-project-found-error";
import {useNavigateToPBoxCreate} from "@/features/box/hooks/navigate-to-box-create";
...
export const ProjectEdit = () => {
    ...
    const navigateToBoxCreate = useNavigateToPBoxCreate()
    ...
    return (
        <>
            <div className="flex items-center justify-between">
                ...
                <Button
                    onClick={() => navigateToBoxCreate(currentProjectId)}
